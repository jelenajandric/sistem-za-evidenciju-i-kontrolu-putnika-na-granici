...
public class TerminalServiceServiceLocator extends org.apache.axis.client.Service implements org.unibl.etf.soapservice.TerminalServiceService {
    ...
    private java.lang.String TerminalService_address = "http://localhost:8080/CentralRegistry/services/TerminalService";
    ...
    public org.unibl.etf.soapservice.TerminalService getTerminalService() throws javax.xml.rpc.ServiceException {
    ...
    public org.unibl.etf.soapservice.TerminalService getTerminalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.unibl.etf.soapservice.TerminalServiceSoapBindingStub _stub = new org.unibl.etf.soapservice.TerminalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.unibl.etf.soapservice.TerminalService.class.isAssignableFrom(serviceEndpointInterface)) {
                org.unibl.etf.soapservice.TerminalServiceSoapBindingStub _stub = new org.unibl.etf.soapservice.TerminalServiceSoapBindingStub(new java.net.URL(TerminalService_address), this);
                _stub.setPortName(getTerminalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapservice.etf.unibl.org", "TerminalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapservice.etf.unibl.org", "TerminalService"));
        }
